package com.utn.Sprint_3;

import com.utn.Sprint_3.entidades.*;
...
import com.utn.Sprint_3.enumeraciones.TipoProducto;
import com.utn.Sprint_3.repositorios.*;
...
public class Sprint_3Application {
	...
	public static void main(String[] args) {
		SpringApplication.run(Sprint_3Application.class, args);
 ...
 */
			...
			Cliente clienteRecuperado3 = clienteRepository.findById(cliente3.getId()).orElse(null);
			...
			if (clienteRecuperado != null) {
				...
				for (Pedido pedidos: clienteRecuperado.getPedidos()){
					pedidos.getDomicilio().mostrarDomicilios();
				}
			}
			if (clienteRecuperado2 != null) {
				...
				for (Pedido pedidos2: clienteRecuperado2.getPedidos()){
					pedidos2.getDomicilio().mostrarDomicilios();
				}
			}
			if (clienteRecuperado3 != null) {
				...
				for (Pedido pedidos3: clienteRecuperado3.getPedidos()){
					pedidos3.getDomicilio().mostrarDomicilios();
				}
			}
		};
	}
